...
public class PrintSeams {
    ...
    public static void main(String[] args) {
        Picture picture = new Picture("C:\\Users\\Zhang\\IdeaProjects\\Part2_Assigment2\\src\\12x10.png");
        StdOut.printf("%s (%d-by-%d image)\n", "C:\\Users\\Zhang\\IdeaProjects\\Part2_Assigment2\\src\\12x10.png", picture.width(), picture.height());
        StdOut.println();
